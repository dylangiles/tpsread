...
# Time structure
TIME_STRUCT = Struct(
    "time_struct", Byte("centisecond"), Byte("second"), Byte("minute"), Byte("hour")
)
                    ...
                    if (
                        ...
                        for field in table_definition.record_table_definition_field:
                            ...
                            if field.type == "BYTE":
                                ...
                                # TODO
                                if (
                                    field.name.decode(encoding="cp437")
                                    .split(":")[1]
                                    .lower()
                                    ...
                                    if SLInt32("long").parse(field_data) == 0:
                                        ...
                                        value = date.fromordinal(
                                            657433 + SLInt32("long").parse(field_data)
                                        )
                                elif (
                                    field.name.decode(encoding="cp437")
                                    .split(":")[1]
